...
Generate an empathetic response that acknowledges their distress and reassures them. Do NOT ask any questions - just provide emotional support and reassurance."""
    ...
    def start_assessment(self, chief_complaint: str) -> Dict[str, Any]:
        ...
        # Handle simple greetings gracefully before running FAISS matching
        if self._is_greeting(chief_complaint):
            greeting_prompt = "Hi there! I'm here to help. What symptoms are you experiencing today?"
            self._capture_debug("[Engine] 🙋 Greeting detected – prompting for symptoms")
            return {
                'success': True,
                'status': 'awaiting_chief_complaint',
