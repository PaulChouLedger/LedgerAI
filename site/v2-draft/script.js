/* ============================================================
   AURAVISION — Premium Product Page Scripts (v50)
   All existing functionality preserved: particles, team network,
   TG feed, live chat, typewriter, localStorage, sentence splitting
   ============================================================ */
...
(function () {
  ...
  function animateCounters() {
    ...
    statNumbers.forEach(el => {
      ...
      if (target === 0) {
        // Zero stays zero but we give it a flicker effect
        el.textContent = '0';
        el.style.opacity = '0';
        setTimeout(() => {
