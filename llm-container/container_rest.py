...
BASE_MODEL_PATH = os.getenv('BASE_MODEL_PATH', "/models/Qwen2.5-7B-Instruct-Q4_K_M.gguf")
# CoT model path — same 7B model handles both conversation and RAG/CoT
COT_MODEL_PATH = os.getenv('COT_MODEL_PATH', "/models/Qwen2.5-7B-Instruct-Q4_K_M.gguf")
    ...
    if combined_context:
        ...
        if stream and needs_filler_phrase and not is_conversational:
            ...
            def response_with_filler():
                ...
                max_tokens_limit = MAX_TOKENS_RAG_MODE_LIST if is_list_request else MAX_TOKENS_RAG_MODE
                llm_response = llm_chat_simple(messages, max_tokens=max_tokens_limit, stream=True, use_cot_model=False)
