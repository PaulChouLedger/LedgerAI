            ...
            if is_instruction_request:
                ...
                if is_list_request:
                    list_instruction = (
                        ...
                        "2. Process Section 1 completely - read from beginning to end, identify ALL matching items, write them down "
                        "3. Process Section 2 completely - read from beginning to end, identify ALL matching items, add them to your list "
                        "4. Process Section 3 completely (if present) - read from beginning to end, identify ALL matching items, add them to your list "
                        "5. Continue this for EVERY remaining section - process each one completely "
                ...
                system_content = (
                    ...
                    "- For list questions: Process EVERY section separated by '---' completely. Scan each section from start to finish to find EVERY item that matches. IMPORTANT: A single section may contain MULTIPLE matching items - do NOT stop after finding one, continue reading to find ALL items in that section. Missing any is a serious error. List all items concisely.\n"
                    "- Answer THOROUGHLY but CONCISELY: Cover all information needed to answer the question completely and thoroughly, but be brief and direct in your response\n"
