        ...
        if has_rag_context:
            ...
            if is_instruction_request:
                ...
                simple_instructions = (
                    ...
                    "2. CRITICAL: Before responding, check if the query is:\n"
                    "   - An incomplete sentence (starts with 'and', 'but', 'or', 'so', 'then', 'also', 'plus', 'make sure', 'ensure', etc.)\n"
                    "   - An instruction or command rather than a question\n"
                    "   - Unclear, nonsensical, or doesn't make logical sense\n"
                    "   - Missing context from a previous conversation\n"
                    "   If ANY of these are true, DO NOT force it into a response. Instead, politely ask the user to clarify or rephrase. Example: 'I'm not sure I understand. Could you please rephrase your question or provide more context?'\n"
