        ...
        if has_rag_context:
            ...
            if is_instruction_request:
                ...
                few_shot_examples = (
                    ...
                    "Example 1 - List Question (FORMAT EXAMPLE ONLY - USE ACTUAL DATA FROM YOUR CONTEXT):\n"
                    "Query: 'Who are the co-founders of Company X?'\n"
                    "Chunk 1: '[Person A] is CEO and Co-Founder of Company X. [Person A] leads the engineering team. "
                    "[Person B] is Co-Founder and CTO of Company X. [Person B] manages product development. "
                    "[Person C] works as Head of Sales at Company X.'\n"
                    "Correct approach: Read the ENTIRE chunk. Extract: [Person A] (Co-Founder of Company X - HIGH), "
                    "[Person B] (Co-Founder of Company X - HIGH). Exclude: [Person C] (Head of Sales, not Co-Founder - LOW).\n"
                    "⚠️ CRITICAL: This example shows the FORMAT only. You MUST extract ACTUAL names from the 'Knowledge context' sections provided above. "
                    "DO NOT use placeholder names like '[Person A]' or example names - only use real names that appear in the Knowledge context.\n\n"
                    ...
                    "Entry 3: I began to question my decisions. Entry 4: The doubt grew stronger.'\n"
                    "Correct approach: Read the ENTIRE chunk. Extract ALL emotional themes: isolation (appears twice), "
                    "questioning/doubt (appears twice). Don't stop after finding 'isolation' - continue reading.\n\n"
                    "Example 3 - Multi-part Question:\n"
                    "Query: 'Identify recurring patterns and extract themes from my documents.'\n"
                    "Chunk 1: 'Pattern 1: Deferring to authority figures. Pattern 2: Self-doubt in decision-making. "
                    "Theme: Need for validation. Theme: Fear of making mistakes.'\n"
                    "Correct approach: Read the ENTIRE chunk. Extract BOTH patterns AND themes. "
                    "Don't stop after finding patterns - continue to find themes.\n\n"
                )
                ...
                few_shot_examples = (
                    ...
                    "Correct approach: Read the ENTIRE chunk. Extract BOTH patterns AND themes. "
                    "Don't stop after finding patterns - continue to find themes.\n\n"
                    "Example 4 - Complex Personal Document Analysis:\n"
                    "Query: 'What emotional states show up most often when I deferred judgment to others?'\n"
                    "Chunk 1: 'In 2015, I deferred to my manager's decision. I felt uncertain and anxious. "
                    "In 2017, I again deferred judgment. The anxiety returned. In 2019, I deferred once more. "
                    "I felt doubt and fear.'\n"
                    "Correct approach: Read the ENTIRE chunk. Extract ALL emotional states mentioned with deferring: "
                    "uncertain, anxious (appears twice), doubt, fear. Don't stop after finding one emotional state.\n\n"
                )
