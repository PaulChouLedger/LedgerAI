        ...
        if has_rag_context:
            ...
            if is_instruction_request:
                ...
                cot_system_prompt = (
                    ...
                    "- CRITICAL: Do NOT use format like \"REASONING:Item:...\" (no space, no newline).\n"
                    "- FORBIDDEN FORMATS (NEVER USE THESE - YOUR RESPONSE WILL BE WRONG):\n"
                    "  ❌ REASONING:- Item:... - Evidence:... - Action:... (one-line format)\n"
                    "  ❌ REASONING:Item:... (no space, no newline)\n"
                    "  ❌ REASONING: - Item:... (space but no newline)\n"
                    "  ❌ REASONING:- CRITICAL:For co-founder queries... (any text on same line as REASONING:)\n"
                    "- REQUIRED FORMAT (ALWAYS USE THIS - THIS IS THE ONLY CORRECT FORMAT):\n"
                    "  ✅ REASONING:\n"
                    "  ✅ - Item: John Smith\n"
                    "  ✅ - Evidence: \"John Smith is the CEO of TechCorp\"\n"
                    "  ✅ - Action: [KEEP]\n"
                    "  ✅ - Item: Jane Doe\n"
                    "  ✅ - Evidence: \"Jane Doe is the CFO of TechCorp\"\n"
                    "  ✅ - Action: [DISCARD]\n"
                    "  ✅ - End of scan.\n"
                    "  ✅ FINAL ANSWER:\n"
                    "- This format is MANDATORY for ALL queries - no exceptions, no variations.\n"
                    "- CRITICAL: If you do not use this exact format, your response is INCORRECT.\n\n"
                    ...
                    "- CRITICAL: Do NOT confuse similar roles (e.g., COO ≠ CEO, CFO ≠ CEO, CMO ≠ CEO). Only mark [KEEP] if the role matches the query (case-insensitive for role terms).\n\n"
                    "KEEP/DISCARD:\n"
                    ...
                    "- CRITICAL: For role-based queries (co-founder, founder, CEO, CFO, etc.): Match is case-insensitive and handles variations (e.g., \"co-founder\" = \"Co-Founder\" = \"cofounder\" = \"CoFounder\").\n"
