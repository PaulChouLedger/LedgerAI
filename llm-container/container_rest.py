        ...
        if has_rag_context:
            ...
            if is_instruction_request:
                ...
                if SHOW_REASONING_DEBUG:
                    reasoning_instruction = (
                        "\n\n🔍 DEBUG MODE: SHOW YOUR REASONING\n"
                        "Before providing your final answer, show your step-by-step reasoning process in the response:\n"
                        "1. What is the user asking for? (State the question clearly)\n"
                        "2. How many context sections do you see? (Count them)\n"
                        "3. For each context section, analyze:\n"
                        "   - What information does this section contain?\n"
                        "   - Does it directly answer the question?\n"
                        "   - What specific facts or details are relevant?\n"
                        "4. After reviewing all sections, list all items/people/entities you found that answer the question\n"
                        "5. Verify: Did you check ALL sections? Did you miss anything?\n"
                        "6. Finally, provide your answer based on the information you found\n\n"
                        "Format: Use clear numbered steps to show your reasoning, then provide the final answer.\n\n"
                    )
