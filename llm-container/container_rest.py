            ...
            if is_instruction_request:
                ...
                if is_list_request:
                    list_instruction = (
                        ...
                        "Read each section word by word to find ALL items that match what is being asked. "
                        ...
                        "Exclude items that are similar but don't match exactly (e.g., if asked about co-founders of Company X, exclude advisors, employees, or co-founders of other companies). "
                ...
                system_content = (
                    ...
                    "- Carefully examine every sentence in every section to understand what information is present\n"
                    "- Do not skip any part - read each section completely from start to finish\n"
                    "- Extract ALL information that directly answers the question\n"
                    "- For list questions: Scan every section completely to find EVERY item - missing any is a serious error\n"
                    "- Be extremely precise: Only include items with the EXACT relationship being asked about\n"
