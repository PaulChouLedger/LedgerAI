        ...
        if has_rag_context:
            ...
            if is_instruction_request:
                ...
                simple_instructions = (
                    ...
                    "2. CRITICAL: If the user's query is unclear, nonsensical, or doesn't make logical sense, DO NOT force it into a response. Instead, politely ask the user to clarify or repeat their question. Example: 'I'm not sure I understand your question. Could you please rephrase it or provide more details?'\n"
