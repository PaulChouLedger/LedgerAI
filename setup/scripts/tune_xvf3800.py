...
def configure_agc_20_ec():
    ...
    print("  - AGC: ENABLED (target: 0.22 RMS, max gain: 6.0x linear = ~15.6 dB, response: 0.1s)")
    ...
    run_xvf_command("PP_AGCDESIREDLEVEL", 0.22)
    run_xvf_command("PP_AGCMAXGAIN", 6.0)  # Linear gain factor (6.0x = ~15.6 dB)
    ...
    save_config_state('agc_20_ec', {
        ...
        'PP_AGCMAXGAIN': 6.0,  # Linear gain factor (6.0x = ~15.6 dB)
