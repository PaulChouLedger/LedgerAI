...
def configure_agc_20_ec():
    ...
    print("  - AGC: ENABLED (target: 0.12 RMS, max gain: 2.0x linear = ~6.0 dB, response: 0.1s)")
    ...
    run_xvf_command("PP_AGCDESIREDLEVEL", 0.12)
    run_xvf_command("PP_AGCMAXGAIN", 2.0)  # Linear gain factor (2.0x = ~6.0 dB)
    ...
    save_config_state('agc_20_ec', {
        ...
        'PP_AGCMAXGAIN': 2.0,  # Linear gain factor (2.0x = ~6.0 dB)
