...
# @markdown **CRITICAL: Echo Emphasis in Negative Samples**
...
# @markdown 4. Upload multiple samples (10-50 recommended) with different volume levels, room conditions, distances, and background noise
...
if uploaded:
    ...
    for filename, file_content in uploaded.items():
        ...
        try:
            ...
            if sr != 16000:
                ...
                print(f"  Converting {filename} from {sr}Hz to 16000Hz...")
            ...
            print(f"  Warning: Could not verify/convert {filename}: {e}")
    ...
    print("\nNo files uploaded. You can run this cell again to upload TTS echo samples.")
...
if os.path.exists(tts_echo_dir) and len(os.listdir(tts_echo_dir)) > 0:
    ...
    print(f"\nNo TTS echo samples uploaded. Consider adding them to improve model robustness.")
