...
def _ring_color(
    ...
    PINK_PLANETS = [
        ("Rose",    [(0.0, (68, 28, 52)), (0.5, (195, 110, 155)), (1.0, (55, 22, 42))]),
        ("Blush",   [(0.0, (85, 35, 60)), (0.4, (215, 140, 175)), (0.7, (235, 180, 210)),
                     (1.0, (85, 35, 60))]),
        ("Quartz",  [(0.0, (48, 18, 38)),  (0.35, (165, 85, 130)), (0.65, (200, 140, 175)),
                     (0.85, (225, 180, 205)), (1.0, (48, 18, 38))]),
        ("Mauve",   [(0.0, (55, 25, 45)), (0.3, (155, 90, 130)), (0.6, (195, 145, 175)),
                     (0.85, (165, 105, 140)), (1.0, (55, 25, 45))]),
        ("Orchid",  [(0.0, (62, 22, 52)), (0.4, (185, 95, 155)), (0.7, (220, 145, 190)),
                     (1.0, (62, 22, 52))]),
    ]

    # Steel palette — neutral gunmetal gray, subtle cool undertone
    STEEL_PLANETS = [
        ("Gunmetal",  [(0.0, (22, 24, 30)),  (0.5, (75, 82, 95)),   (1.0, (18, 20, 24))]),
        ("Titanium",  [(0.0, (32, 36, 44)),  (0.4, (105, 112, 128)),(0.7, (155, 162, 178)),
                       (1.0, (32, 36, 44))]),
        ("Graphite",  [(0.0, (16, 18, 22)),  (0.35, (55, 60, 72)),  (0.65, (92, 100, 118)),
                       (0.85, (125, 132, 150)), (1.0, (16, 18, 22))]),
        ("Platinum",  [(0.0, (42, 46, 54)),  (0.3, (118, 124, 140)),(0.6, (168, 175, 190)),
                       (0.85, (135, 140, 158)), (1.0, (42, 46, 54))]),
        ("Brushed",   [(0.0, (26, 28, 34)),  (0.4, (80, 86, 100)),  (0.7, (115, 122, 140)),
                       (1.0, (26, 28, 34))]),
    ]
