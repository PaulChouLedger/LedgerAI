...
TARGET_RMS_FOR_WHISPER = 0.22      # Target RMS level (used for all audio processing in shared pipeline)

# === Soft Clipping Prevention ===
ENABLE_SOFT_LIMITER = True       # Prevent clipping from near-field speech (enabled to handle brief peaks)
