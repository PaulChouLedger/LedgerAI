...
SILENCE_TIMEOUT = 0.2
VAD_THRESHOLD = 0.15  # Balanced threshold - filters noise but catches initial words
MIC_GAIN = 4.0  # Increased gain - good amplitude range, no clipping detected
MIN_SPEECH_DURATION = 0.25  # Minimum speech duration in seconds to prevent noise triggers
VAD_RESET_THRESHOLD = 0.10  # If VAD stays below this for too long, reset
